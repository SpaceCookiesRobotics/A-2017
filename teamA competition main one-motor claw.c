...
#pragma config(Sensor, dgtl1,  jumperX,        sensorDigitalIn)
#pragma config(Sensor, dgtl2,  tip,            sensorTouch)
#pragma config(Sensor, dgtl3,  jumperY,        sensorDigitalIn)
#pragma config(Sensor, dgtl5,  jumper1,        sensorDigitalIn)
#pragma config(Sensor, dgtl7,  jumper2,        sensorDigitalIn)
#pragma config(Sensor, dgtl9,  jumper3,        sensorDigitalIn)
#pragma config(Sensor, dgtl10, led,            sensorDigitalOut)
#pragma config(Sensor, dgtl11, jumper4,        sensorDigitalIn)
...
//different autonomous functions
...
void autonomous() {
	...
	else if () {//when turning right on the blue alliance, without scoring the preload cone
	scoreRightConeBlue();
	}
	else if () {//when turning right on the blue alliance, without scoring te preload cone
	scoreRightConeBlue();
	}
	else if () {//when turning left on the red alliance, without scoring the preload cone
	scoreLeftConeRed();
	}
	*/
